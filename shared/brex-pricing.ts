...
export const BREX_LINE_ITEMS: BrexLineItem[] = [
  {
    ...
    sourceUrls: [
      ...
      "https://markcmo.com/marketing-audit",
      "https://markcmo.com/fractional-cmo-cost",
    ],
    positioning: "at-floor",
    notes: "5-day written executive diagnostic. Credit applied toward retainer within 30 days. Standalone strategy audits run $5K–$25K (ConsultFees 2026, MarkCMO 2026).",
  },
  {
    key: "advisory-hour",
